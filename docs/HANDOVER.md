...
| Local plugin packaging | Complete | Repo marketplace, branded install-page assets, cache-safe stdio launcher, real Codex CLI install, fresh-host eight-tool smoke test, and verified guide |
