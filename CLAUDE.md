...
Before changing this repository, read `AGENTS.md` in full and follow its
canonical context order, product invariants, worktree rules, and definition of
done. Then read `docs/HANDOVER.md` for the latest product and repository state.
